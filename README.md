...
By default, a build process involving a [conda](https://docs.conda.io/en/latest/) environment is supported.
  ...
  - navigate into your project directory (dynamic_r2)
  - create the `conda` environment for installation as follows:
  
     `conda env create -f environment.yaml`
  - activate the conda environment:
  
     `conda activate dynamic_r2-env`
  ...
  - run `configure`:
	 ...
	 `./configure --with-boost=/path/to/miniconda3/envs/dynamic_r2-env --with-boost-libdir=/path/to/miniconda3/envs/dynamic_r2-env/lib`
...
02 02 2021: project generated from cookiecutter template
